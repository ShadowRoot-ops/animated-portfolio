    ...
    <footer className="bg-stone-900 text-white" id="contact">
      <div className="container">
        <div className="section py-16">
          ...
          <div className="grid md:grid-cols-3 md:items-center">
            <div className="md:col-span-2">
              ...
              <Button
                ...
                iconAfter={
                  <div className="size-6 overflow-hidden">
                    <div className="w-12 h-6 flex transition-transform duration-300 group-hover/buttton:-translate-x-1/2">
                      <svg
              ...
              >
                aniketsharmaaksh@gmail.com
              </Button>
            </div>
            <div>
              <nav className="flex flex-col md:items-end gap-8 mt-16 md:mt-0">
                {navItems.map(({ href, label }) => (
                  <a href={href} key={label} onClick={handleClickNav}>
        ...
        <p className="py-16 text-white/30 text-sm">
          Copyright &copy; Aniket Sharma &bull; All rights reserved
        </p>
      </div>
    </footer>
  );
